...
sortNames=runners.map(function(element){
...
// Problem 2
// how many peopler from skinix company 
let skinixComp = [];

skinixComp = runners.filter( element => element.company_name === 'Skinix');


console.log(skinixComp.length);
